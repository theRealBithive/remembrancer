...
class ReviewedFilter(admin.SimpleListFilter):
    """The queue: finished, not yet written up."""

    title = "review state"
    parameter_name = "reviewed"

    def lookups(self, request, model_admin):
        return [("queue", "Finished, awaiting review"), ("yes", "Reviewed"), ("no", "No review")]
...
class BookAdmin(admin.ModelAdmin):
    ...
    list_display = ("thumb", "title", "authors", "narrators", "is_finished", "has_review",
